...
<body>
	...
	$compteRendu = $_SESSION['compteRendu'];
	?>
	<!-- End Navigation -->
					...
					<div id="heading-box-cnt">
						...
						<div class="featured-main-joueur">
							<form id="form1" action="EnregistrerCompteRendu.php" method="post" enctype="multipart/form-data">
								...
								<input type="hidden" name="id" id="id" value="<?php echo $compteRendu->getRencontre();?>"/>
								<fieldset><legend>Modification du compte rendu du match</legend>
								<p class="first" id="container" >
									<label for="texte">Contenu</label>
									<textarea name="texte" id="texte" cols="10" rows="10"><?php echo $compteRendu->getTexte();?></textarea>
								</p>
								</fieldset>
								<!--<fieldset>
								<p id="container" >
									<label for="photo">Photo</label>
									<img id="visuPhoto" src="images/article/<?/*php echo $compteRendu->getPhoto();*/?>" style="width: 314px; height: 200px; cursor: pointer; ">
								</p>
								</fieldset>-->
