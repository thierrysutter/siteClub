	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".cr").click(function(){
				$.ajax({ // fonction permettant de faire de l'ajax
				   ...
				   data: {id : $(this).prop('id').split('_')[1], mode : "popup"}, // données è transmettre
				   dataType: 'json', // JSON
				   ...
				   error: function(){
					   // on affiche un message d'erreur dans le span prévu è cet effet
		...
		function enregistrerCompteRendu(idRencontre) {
			...
			$.ajax({ // fonction permettant de faire de l'ajax
			   ...
			   data: {id: idRencontre, texte : $("#texteCompteRenduPopup").val(), methode: "create", zone : "compteRendu"}, // données è transmettre
			   dataType: 'json', // JSON
			   success: function(){
