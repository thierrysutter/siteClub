...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$("#submit").click( function() {	// � la soumission du formulaire
				
				if (validFormulaire()) {
					$.ajax({ // fonction permettant de faire de l'ajax
					   type: "POST", // methode de transmission des donn�es au fichier php
					   url: "EnregistrerMotDePasse.php", // url du fichier php
					   data: "login="+$("#login").val()+"&ancienMdp="+$("#ancienMdp").val()+"&nouveauMdp="+$("#nouveauMdp").val()+"&confirmMdp="+$("#confirmMdp").val(), // donn�es � transmettre
	    ...
	    <div class="container">
	      ...
	      <div class="row my-4">
	      	<div class="col-md-12 col-12 col-sm-12 col-lg-12 col-xl-12">
				<div id="messageConnexion" style="text-align: center; height: 5px; color: red; font-size: 14px; font-weight: bold; ">Pour plus de s�curit� et obtenir l'acc�s � l'espace membre, merci de mettre � jour votre mot de passe.</div>
