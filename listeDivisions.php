			...
			<div id="heading-cnt">
				...
				<div id="side-nav">
					<ul>
						...
						<form id="filtre" name="filtre" action="ActionDivision.php" method="post">
				...
				<div id="heading-box">
					<div id="heading-box-cnt">
							...
							<div class="CSSTableGenerator" style="text-align: center; max-height: 235px; overflow: auto;">
								<table id="tableATrier">
									...
									<tr>
									  ...
									  <th>Fédération<br><img src="images/sort-asc.png" style="border: 0;"/><img src="images/sort-desc.png" style="border: 0;"/></th>
									...
									<tr class="centre">
										<td><?php echo $division->getLibelle();?></td>
										<td><?php echo "FFF"; ?></td>
										<td><?php echo $division->getLibelleCategorie();?></td>
										<td>
											<img class="fiche" id="fiche_<?php echo $division->getId();?>" src="images/modify16.png" style="border: 0;cursor: pointer;" title="Modifier"/>
											<img class="suppression" id="suppr_<?php echo $division->getId();?>" src="images/trash16.png" style="border: 0;cursor: pointer;" title="Supprimer"/>
										</td>
									</tr>
									<?php } ?>
								</table>
						...
						<div class="featured-main-joueur-bas" style="padding-top: 4px;text-align: center;width: 100%; height: 280px;">
							<button class="bouton" id="ajoutCompetition" type="submit">Ajouter une division</button>
						</div>
						<!-- End Main Slide Item -->
