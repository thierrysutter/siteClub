	    ...
	    <div class="container">
	      <div class="row">
	        <div class="col-md-12 col-12 col-sm-12 col-lg-12 col-xl-12">
	          <form action="ActionDivision.php" method="post" name="filtre">
	...
	<div class="py-3">
	    <div class="container">
	      ...
	      <div class="row text-center py-4">
		      <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
		      	<input type="button" id="ajoutDivision" class="btn btn-success btn-lg active" value="Ajouter une division"/>
		      </div>
	      </div>
	    </div>
	</div>
