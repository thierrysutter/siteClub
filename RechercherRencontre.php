...
$logger->log('info', 'infos', "Entrée dans RechercherRencontre.php", Logger::GRAN_MONTH);
...
try {
	...
	$rencontre = $manager->get($idRencontre);
	$_SESSION['rencontre'] = $rencontre;
	
	header("Location: modificationRencontre.php");
