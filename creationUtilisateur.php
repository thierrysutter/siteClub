	      ...
	      <div class="row">
	        <div class="col-md-12 col-12 col-sm-12 col-lg-12 col-xl-12">
	        	<form id="" action="EnregistrerUtilisateur.php" method="post" enctype="multipart/form-data">
	        		...
	        		<h3 class="mx-5 pb-3">Ajouter un utilisateur</h3>
			        ...
			        <div class="form-group row mx-5">
			        	...
			        	<div class="col-sm-11">
			        		<input class="form-control w-100 form-control-md" type="text" name="login" id="login" value="" required/>
			        	</div>
			        </div>
			        <div class="form-group row mx-5">
			        	<label class="col-sm-1 col-form-label" for="password">Password</label>
			        	<div class="col-sm-11">
			        		<input class="form-control w-100 form-control-md" type="password" name="password" id="password" value="" required/>
			        	</div>
			        </div>
			        <div class="form-group row mx-5">
			        ...
			        <div class="form-group row mx-5">
			        	...
			        	<div class="col-sm-1">
			        		<input class="form-control w-100 form-control-md" type="checkbox" name="superAdmin" id="superAdmin" value="1"/>
			        	</div>
			        </div>
			        ...
			        <div class="form-group row mx-5">
			        	...
			        	<div class="col-sm-11">
			        		<input class="form-control w-100 form-control-md" type="text" name="adresse" id="adresse" value="" required/>
			        	</div>
			        </div>
			        <div class="form-group row mx-5">
			        	<label class="col-sm-1 col-form-label" for="codePostal">Code postal</label>
			        	<div class="col-sm-2">
			        		<input class="form-control w-100 form-control-md" type="text" name="codePostal" id="codePostal" value="" required/>
			        	</div>
			        </div>
			        <div class="form-group row mx-5">
			        	<label class="col-sm-1 col-form-label" for="ville">Ville</label>
			        	<div class="col-sm-11">
			        		<input class="form-control w-100 form-control-md" type="text" name="ville" id="ville" value="" required/>
			        	</div>
			        </div>
			        <div class="form-group row mx-5">
			        	<label class="col-sm-1 col-form-label" for="telFixe">Tel fixe</label>
			        	<div class="col-sm-3">
			        		<input class="form-control w-100 form-control-md" type="text" name="telFixe" id="telFixe" value="" required/>
			        	</div>
			        </div>
			        <div class="form-group row mx-5">
			        	<label class="col-sm-1 col-form-label" for="telPortable">Tel portable</label>
			        	<div class="col-sm-3">
			        		<input class="form-control w-100 form-control-md" type="text" name="telPortable" id="telPortable" value="" required/>
			        	</div>
			        </div>
			        <div class="form-group row mx-5">
