	      ...
	      <div class="row">
	        <div class="col-md-12 col-12 col-sm-12 col-lg-12 col-xl-12">
	          <form action="EnregistrerProfil.php" method="post" name="form1" >
	            ...
	            <div class="form-group row mx-5">
	              <label for="inputPrenom" class="col-form-label col-sm-1">Pr�nom</label>
	              <div class="col-sm-5">
	                <input type="text" class="form-control w-100 form-control-md" id="inputPrenom" name="prenom" placeholder="Pr�nom" value="<?php echo $user->getPrenom();?>">
	              </div>
	              <label for="inputTelFixe" class="col-form-label col-sm-1">T�l. fixe</label>
	              <div class="col-sm-5">
	                <input type="text" class="form-control w-100 form-control-md" id="inputTelFixe" name="telFixe" placeholder="T�l�phone fixe" value="<?php echo $user->getTelFixe();?>">
	              </div>
	            </div>
	            <div class="form-group row mx-5">
	              ...
	              <label for="inputTelPort" class="col-form-label col-sm-1">T�l. portable</label>
	              <div class="col-sm-5">
	                <input type="text" class="form-control w-100 form-control-md" id="inputTelPort" name="telPortable" placeholder="T�l�phone portable" value="<?php echo $user->getTelPortable();?>">
	              </div>
	            </div>
	            <div class="form-group row mx-5">
