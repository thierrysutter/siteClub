					...
					<ul>
						<li>
							<div style="text-align: center;">
								<!--
								<img id="visuPhoto" style="width: 150px; height: 100px; cursor: pointer; vertical-align: middle;"/>
								 -->
							</div>
						</li>
					</ul>
					...
					<div id="heading-box-cnt">
						...
						<div class="featured-main-joueur">
							...
							<input type="hidden" name="methode" id="methode" value="create"/>
								<fieldset><legend>Ajout d'un article</legend>
								...
								<p id="container">
									<div id="dropbox">
										<span class="message">Déposer les images ici (6 maximum).</span>
									</div>
								</p>
