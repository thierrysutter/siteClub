				...
				<div id="heading-box">
					<div id="heading-box-cnt">
						...
						<div class="featured-main-joueur">
							<form id="form1" action="EnregistrerArticle.php" method="post" enctype="multipart/form-data">
								<input type="hidden" name="methode" id="methode" value="modif"/>
								<input type="hidden" name="id" id="id" value="<?php echo $article->getId();?>"/>
								<fieldset><legend>Modification d'un article</legend>
								<p class="first" id="container" >
									<label for="titre">Titre</label>
									<input type="text" name="titre" id="titre" value="<?php echo $article->getTitre();?>"/>
								</p>
								<p id="container" >
									<label for="texte">Contenu</label>
									<textarea name="texte" id="texte" cols="10" rows="10"><?php echo $article->getTexte();?></textarea>
								</p>
								</fieldset>
								<fieldset>
								<p id="container" >
								...
								<?php if ($modifArticle == 1) {?>
								<p class="submit"><button type="submit" style="width: 107px; height:25px; line-height:25px; " value="Enregistrer">Enregistrer</button>
								<button type="reset" id="reset" style="width: 107px; height:25px; line-height:25px; " value="Annuler">Annuler</button></p>
								<?php } else {?>
								<p class="submit"><button type="reset" id="reset" style="width: 107px; height:25px; line-height:25px; " value="Annuler">Retour</button></p>
								<?php } ?>
