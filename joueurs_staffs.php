...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$("#lienSeniors").addClass("active");
			$("#lienVeterans").removeClass("active");

			$("#lienSeniors").click(function(e) {
				e.preventDefault();
				$(".active").removeClass("active");
				$(this).addClass("active");
			});
			$("#lienVeterans").click(function(e) {
				e.preventDefault();
				$(".active").removeClass("active");
				$(this).addClass("active");
			});
			...
			<div id="heading-cnt">
				...
				<div id="side-nav">
					<ul>
						...
						<li id="lienSeniors"><div class="link"><a href="#">Séniors</a></div></li>
						<!--<li id="lienVeterans"><div class="link"><a href="#">Vétérans</a></div></li>-->
					</ul>
				</div>
				<!-- End Sub nav -->
							...
							<div class="autoplay8">
								...
								if (!empty($listeGardiens)) {
									foreach($listeGardiens as $gardien) {
										if ($gardien->getPhoto() != null && $gardien->getPhoto() != "" && file_exists("images/photo/".$gardien->getPhoto())) {
								?>
								<div><img src="images/photo/<?php echo $gardien->getPhoto();?>" width="80" height="80"/></div>
								<?php }}}
							  ...
							  <div><img src="images/silhouette.jpeg" width="80" height="80"/></div>
							  <div><img src="images/silhouette.jpeg" width="80" height="80"/></div>
							  <div><img src="images/silhouette.jpeg" width="80" height="80"/></div>
							  <div><img src="images/silhouette.jpeg" width="80" height="80"/></div>
							  <div><img src="images/silhouette.jpeg" width="80" height="80"/></div>
						...
						<div class="featured-main-joueur-bas">
							<div class="featured-main-joueur-details-gauche">
								<div class="featured-main-joueur-details-gauche-cnt">
									...
									<p>Les mardis et jeudis de 19h à 21h</p>
								</div>
								<div class="featured-main-joueur-details-gauche-cnt">
								...
								<div class="featured-main-joueur-details-gauche-cnt">
									<a href="#" id="btnEffectif" class="bouton">Effectif</a>
									<a href="#" id="btnStaff" class="bouton">Staff</a>
								</div>
							</div>

							<div class="featured-main-joueur-details-droite">

								<div class="featured-main-joueur-details-droite-cnt">
								...
								<div class="featured-main-joueur-details-droite-cnt">
									<h4><a href="#">Joueur du mois</a></h4>
									<p></p>
								</div>
								<div class="featured-main-joueur-details-droite-cnt">
									<h4><a href="#">Meilleur buteur</a></h4>
									<p></p>
								</div>
								<div class="featured-main-joueur-details-droite-cnt">
									<h4><a href="#">Meilleur passeur</a></h4>
									<p></p>
								</div>
							</div>
						</div>
			...
			<div id="content">
				<div class="featured-main-bas">
					<div id="staff" class="staff featured-main-bas-item">
						...
						?>
						<div class="joueur ">
							<?php if ($staff->getPhoto() != null && $staff->getPhoto() != "" && file_exists("images/photo/".$staff->getPhoto())) { ?>
							<img class="vignette" id="<?php echo $staff->getId(); ?>" src="<?php echo 'images/photo/'.$staff->getPhoto();?>" width="55px" height="65px" alt="" title="Entraineur"/>
							<?php } else {?>
					...
					<div id="gardiens" class="effectif featured-main-bas-item">
						...
						<?php if ($gardien->getPhoto() != null && $gardien->getPhoto() != "" && file_exists("images/photo/".$gardien->getPhoto())) { ?>
						<img class="vignette" id="<?php echo $gardien->getId(); ?>" src="<?php echo 'images/photo/'.$gardien->getPhoto();?>" width="55px" height="65px" alt="" />
						<?php } else {?>
					...
					<div id="defenseurs" class="effectif featured-main-bas-item">
						...
						?>
						<div class="joueur ">
							<?php if ($defenseur->getPhoto() != null && $defenseur->getPhoto() != "" && file_exists("images/photo/".$defenseur->getPhoto())) { ?>
							<img class="vignette" id="<?php echo $defenseur->getId(); ?>" src="<?php echo 'images/photo/'.$defenseur->getPhoto();?>" width="55px" height="65px" alt="" />
							<?php } else {?>
					...
					<div id="milieux" class="effectif featured-main-bas-item">
						...
						?>
						<div class="joueur ">
							<?php if ($milieu->getPhoto() != null && $milieu->getPhoto() != "" && file_exists("images/photo/".$milieu->getPhoto())) { ?>
							<img class="vignette" id="<?php echo $milieu->getId(); ?>" src="<?php echo 'images/photo/'.$milieu->getPhoto();?>" width="55px" height="65px" alt="" />
							<?php } else {?>
					...
					<div id="attaquants" class="effectif featured-main-bas-item">
						...
						?>
						<div class="joueur ">
							<?php if ($attaquant->getPhoto() != null && $attaquant->getPhoto() != "" && file_exists("images/photo/".$attaquant->getPhoto())) { ?>
							<img class="vignette" id="<?php echo $attaquant->getId(); ?>" src="<?php echo 'images/photo/'.$attaquant->getPhoto();?>" width="55px" height="65px" alt="" />
							<?php } else {?>
